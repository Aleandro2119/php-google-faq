...
$paragraphs = [
    ...
    [
        ...
        'text' => [
            ...
            fai clic qui. Una volta che i contenuti saranno stati rimossi e che Google avrà rilevato l'aggiornamento, le informazioni non verranno più visualizzate nei risultati di ricerca di Google. 
    ...
    [
        ...
        'text' => [
            "In alcuni casi sì. Quando fai clic su un risultato della Ricerca Google,
             ...
             della pagina dei risultati di ricerca sotto forma di URL referrer. Talvolta, l'URL della pagina dei risultati di ricerca potrebbe contenere la query di ricerca che hai inserito.
...
<body>
    <?php foreach ($paragraphs as $faqs) { ?>
        <?php foreach ($faqs as $title) { ?>
